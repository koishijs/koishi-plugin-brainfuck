...
export const Config: Schema<Config> = Schema.object({
  cellSize: Schema.natural().default(8).description('每个单元占用的比特数。'),
  memorySize: Schema.natural().default(1024).description('允许的最大单元数目。'),
  maxSteps: Schema.natural().default(16384).description('允许的最大步数。'),
})
...
class BrainFuck {
  ...
  constructor(public source: string, private options: Config) {
